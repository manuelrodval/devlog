import classes from "./styles/Admonition.module.scss"
...
export default function Admonition({ type, title, children }: AdmonitionType) {
  return (
    <div className={`${classes.admonition} ${classes["admonition-" + type]}`}>
      <div className={classes["admonition-heading"]}>
        <h5>
          <div className={classes["admonition-icon"]}>{svgMap[type]}</div>{" "}
          {title || type}
        </h5>
      </div>
